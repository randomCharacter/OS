...
Rezultat se upisuje korišćenjem iteratora sum_begin. Zato je neophodno da vektor nad kojim je
kreiran taj iterator bude kreiran pre poziva funkcije f. Taj vektor mora da sadrži dovoljno mesta
za upis svih elemenata.

Funkciju sumiraj implementirati u fajlu vise_niti.cpp. Ova funkcija treba da pokrene dve niti
koje će, koristeći funkciju f, da izračunaju korespondentne sume vektora. I to tako da svaka
